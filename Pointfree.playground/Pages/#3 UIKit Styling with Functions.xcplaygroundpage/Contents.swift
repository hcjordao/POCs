...
/*:
 ...
 ### Major take aways:
 - On this episode, they broken down all the styling into minor functions to be used on the application for styling
 */
...
/*:
# Review + Expand
 - Try to do this with SwiftUI, how would it look like, to apply a rounded style for a button and a textinput
 */
